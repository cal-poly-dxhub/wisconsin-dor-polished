...
import boto3
import pydantic
from case_opinion import citation_to_raw_slug, fetch_case_opinion, scholar_url
    ...
    for turn in range(MAX_TURNS):
        ...
        for tool_use in tool_uses:
            ...
            if tool_name == "answer":
                ...
                # agent didn't explicitly fetch_case_opinion for. Without
                # this, graph-discovered case law has empty content in the
                # RAGDocument and ResponseStreaming can't incorporate the
                # holding into its regenerated answer.
                _OPINION_BACKFILL_CAP = 3
                unfetched_stubs = [
                    cid for cid in cited
                    if _is_case_law_stub(cid) and cid not in cited_opinions
                ]
