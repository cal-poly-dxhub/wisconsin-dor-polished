...
PACKAGE_MODULES = [
    ...
    "agent_tools.pipeline",
    "agent_tools.stages",
    "agent_tools.stages.base",
    "agent_tools.stages.auto_refine",
    "agent_tools.stages.neptune_search",
    "agent_tools.stages.wpam_dedup",
    "agent_tools.stages.diversity_cap",
    "agent_tools.stages.authority_tiebreak",
    "agent_tools.stages.auto_enrichment",
    "agent_tools.stages.citation_extraction",
    "agent_tools.stages.statute_backfill",
