...
const MOCK_AGENT_TRACE: AgentTraceEvent[] = [
  ...
  { kind: 'tool_result', seq: 14, timestamp: 15, payload: { toolName: 'get_section', summary: 'Got "9.7 Capitalization Rate" (4 chunks) from WPAM Chapter 9 — Income Approach to Value', status: 'ok', metadata: { chunkCount: 4, docId: 'wpam-ch9-income-approach', docTitle: 'WPAM Chapter 9 — Income Approach to Value', heading: '9.7 Capitalization Rate', latencyMs: 120, query: 'capitalization rate derivation', sectionChunkCount: 7, returnedChunkCount: 4, mean: 0.7823, std: 0.0941, zThreshold: 0.5, flatDistribution: false, chunkScores: [{ chunkId: 'c1', cosine: 0.8912, zScore: 1.16, heading: '9.7', subheading: 'Band of Investment', startPage: 84, endPage: 85, included: true }, { chunkId: 'c2', cosine: 0.8645, zScore: 0.87, heading: '9.7', subheading: 'Market Extraction', startPage: 85, endPage: 86, included: true }, { chunkId: 'c3', cosine: 0.8301, zScore: 0.51, heading: '9.7', subheading: 'Built-Up Method', startPage: 86, endPage: 87, included: true }, { chunkId: 'c4', cosine: 0.8199, zScore: 0.40, heading: '9.7', subheading: 'Summation Technique', startPage: 87, endPage: 87, included: true }, { chunkId: 'c5', cosine: 0.7512, zScore: -0.33, heading: '9.7', subheading: 'Historical Trends', startPage: 88, endPage: 88, included: false }, { chunkId: 'c6', cosine: 0.7201, zScore: -0.66, heading: '9.7', subheading: 'Tax Rate Effects', startPage: 89, endPage: 89, included: false }, { chunkId: 'c7', cosine: 0.6990, zScore: -0.88, heading: '9.7', subheading: 'Introduction', startPage: 83, endPage: 84, included: false }] } } },
  // Search Document
