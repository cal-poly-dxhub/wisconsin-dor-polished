  ...
  },
  {
    ...
    payload: {
      ...
      metadata: {
        ...
        caseLawCount: 1,
        statuteBackfill: [
          { chunkId: 'statutes-70_chunk_0080', docId: 'statutes-70', sourceRank: 1, heading: '70.32 Real estate, how valued.  (1) Real property shall be' },
          { chunkId: 'statutes-70_chunk_0138', docId: 'statutes-70', sourceRank: 2, heading: '70.47 Board of review proceedings.  (1) TIME AND' },
        ],
        caselawBackfill: [
          {
            caseId: 'case-law-2017-wi-79',
            title: 'Milewski v. Town of Dover',
            citation: '2017 WI 79',
            summary: 'Interior inspection not required for assessment change; assessor may rely on best information practicably obtainable.',
            relevanceScore: 0.631,
            contentRole: 'analysis_holding',
            citedStubs: ['WIS-STAT-70.47'],
          },
          {
            caseId: 'case-law-2014-wi-9',
            title: 'Sausen v. Town of Black Creek Board of Review',
            citation: '2014 WI 9',
            summary: 'Taxpayer bears burden of proving assessment and classification are erroneous at BOR hearing.',
            relevanceScore: 0.537,
            contentRole: 'analysis_holding',
            citedStubs: ['WIS-STAT-70.32', 'WIS-STAT-70.47'],
          },
          {
            caseId: 'case-law-2011-wi-82',
            title: 'State ex rel. Stupar River LLC v. Town of Linwood',
            citation: '2011 WI 82',
            summary: 'Fair market value is not synonymous with assessed value; individual assessments typically differ from FMV.',
            relevanceScore: 0.536,
            contentRole: 'analysis_holding',
            citedStubs: ['WIS-STAT-70.32'],
          },
        ],
        caselawBackfillMeta: {
          stubsSearched: ['WIS-STAT-70.32', 'WIS-STAT-70.47'],
          candidateCount: 200,
          fetchSaturated: true,
          fetchK: 200,
          latencyMs: 515,
