...
const TAG_META: Record<DiscoveryTag, { label: string; tone: string; description: string }> = {
  'vector-search': {
    ...
    tone: 'border-blue-400 text-blue-800 dark:border-blue-700 dark:text-blue-200',
    description: 'Found via semantic similarity to your question',
  },
  'graph-neighbor': {
    label: 'Related via graph',
    tone: 'border-purple-400 text-purple-800 dark:border-purple-700 dark:text-purple-200',
    description: 'Connected through legal authority or citations',
  },
  fetched: {
    label: 'Directly looked up',
    tone: 'border-teal-400 text-teal-800 dark:border-teal-700 dark:text-teal-200',
    description: 'The agent fetched this specific document by ID',
  },
  'framework-list': {
    label: 'From framework list',
    tone: 'border-slate-400 text-slate-800 dark:border-slate-700 dark:text-slate-200',
    description: 'Part of the authority framework the agent browsed',
  },
  'opinion-fetched': {
    label: 'Court opinion',
    tone: 'border-amber-400 text-amber-800 dark:border-amber-700 dark:text-amber-200',
    description: 'Full court opinion the agent pulled for this citation',
  },
  unknown: {
    label: 'Source',
    tone: 'border-gray-400 text-gray-700 dark:border-gray-700 dark:text-gray-300',
