...
Usage:
    AWS_PROFILE=widor AWS_REGION=us-east-1 python tools/graphrag/cleanup_orphan_chunks.py \
...
def main():
    ...
    if not args.dry_run:
        ...
        logger.info(f"     ./tools/graphrag/run_fargate.sh load --start-phase 9 --stop-after-phase 9")
