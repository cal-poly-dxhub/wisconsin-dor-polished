...
Usage:
    ...
    python tools/graphrag/test_diversity.py

    # Run a single query:
    python tools/graphrag/test_diversity.py --query "how is agricultural land assessed?"

    # Adjust caps:
    python tools/graphrag/test_diversity.py --max-per-doc 4 --top-k 12
"""
