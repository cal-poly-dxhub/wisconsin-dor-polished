...
Usage:
    ...
    python tools/ingestion/ops/extract_faq_qa_pairs.py --dry-run

    # Full upload (us-west-2 is canonical; sync_faq_bucket.sh copies east)
    python tools/ingestion/ops/extract_faq_qa_pairs.py \\
...
from tools.ingestion.lib.faq_url_map import normalize_question  # noqa: E402
