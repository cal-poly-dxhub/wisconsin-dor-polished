...
ALWAYS:
- Search for relevant chunks first via vector_search
- Follow graph edges to find authoritative sources (get_neighbors with CITES, IMPLEMENTS edges)
- Trace authority chains (get_authority_chain) to cite the correct level of authority
...
- Assume FAQ answers are authoritative over statutes or admin rules
